...
my_cart = CartViewSet.as_view({
    "get": "my_cart"          # Savatni ko'rish
})

add_item = CartViewSet.as_view({
    "post": "add_item"        # Mahsulot qo'shish
})

remove_item = CartViewSet.as_view({
    "delete": "remove_item"   # Mahsulotni o'chirish
})

update_item = CartViewSet.as_view({
    "patch": "update_item"    # Miqdorni o'zgartirish
})
